...
public class TestSLACalculatorMemory extends XDataTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        getOozieConfiguration(services).set(Services.CONF_SERVICE_EXT_CLASSES, "org.apache.oozie.service.EventHandlerService,"
    ...
    public void testLoadOnRestart() throws Exception {
        ...
        slaCalcMemory.init(getOozieConfiguration(Services.get()));
