...
public class TestMapReduceActionExecutor extends ActionExecutorTestCase {
    ...
    public void testSetupMethods() throws Exception {
        ...
        getOozieConfiguration(serv).setBoolean("oozie.action.mapreduce.uber.jar.enable", true);
        ...
        getOozieConfiguration(serv).setBoolean("oozie.action.mapreduce.uber.jar.enable", false);
        try {
            actionXml = createUberJarActionXML(getNameNodeUri() + "/app/job.jar", "");
            conf = ae.createBaseHadoopConf(context, actionXml);
            ae.setupActionConf(conf, context, actionXml, getFsTestCaseDir());
        ...
        getOozieConfiguration(serv).setBoolean("oozie.action.mapreduce.uber.jar.enable", originalUberJarDisabled);
